...
export default async function handler(req, res) {
  ...
  const systemPrompt = `你是一名有审美的中文内容编辑，为公众号文章生成卡片预览摘要。摘要要像一段能吸引读者点开的"归档导语"：既说清文章讲什么，也保留一点原文的气息、问题意识或情绪张力。

【核心任务】
用一段话概括文章的主要内容与吸引点，**目标 55-90 字，最多不超过 120 字**。优先写出读者为什么会想看：它解决什么困惑、呈现什么选择、记录什么经历，或留下什么值得回味的问题。
